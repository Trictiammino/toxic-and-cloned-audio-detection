...
# --- Percorsi output ---
OUTPUT_DIR = PROJECT_ROOT / "classifiers" / "random forest" / "violence" / "voice_clone_detection" / "real_vs_chatterbox"
...
# --- Random Forest ---
RF_N_ESTIMATORS = 100       # numero di alberi
RF_MAX_DEPTH = None         # profondità massima degli alberi (None = illimitata)
RF_MIN_SAMPLES_SPLIT = 2    # campioni minimi per splittare un nodo
RF_MIN_SAMPLES_LEAF = 1     # campioni minimi per essere una foglia
RF_MAX_FEATURES = "sqrt"    # feature considerate per ogni split: "sqrt" | "log2" | None
RF_CLASS_WEIGHT = "balanced"  # None | "balanced"

# --- Grid Search ---
GRID_SEARCH_ENABLED = True        # False per saltare la grid search e usare i parametri RF_* sopra
...
def main():
    log.info("=" * 60)
    log.info("Audio Clone Detection — Random Forest Classifier")
    log.info("=" * 60)
