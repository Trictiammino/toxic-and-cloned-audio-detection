...
# --- Percorsi input ---
CSV_CLONED_PATH = PROJECT_ROOT / "generate_cloned_audio" / "chatterbox_tts" / "violence" / "extracted_audio_features" / "audio" / "features_cloned_audio_dataset.csv"  # label "Yes"
CSV_ORIGINAL_PATH = PROJECT_ROOT / "datasets" / "violence" / "extracted_audio_features" / "audio" / "features_real_audio_dataset.csv"  # label "No"

# --- Percorsi output ---
OUTPUT_DIR = PROJECT_ROOT / "classifiers" / "xgboost" / "violence" / "voice_clone_detection" / "real_vs_chatterbox"
...
# --- XGBoost ---
XGB_N_ESTIMATORS = 100      # numero di boosting rounds
XGB_MAX_DEPTH = 6           # profondità massima di ogni albero
XGB_LEARNING_RATE = 0.1     # learning rate (eta)
XGB_SUBSAMPLE = 0.8         # frazione di campioni usata per ogni albero
XGB_COLSAMPLE_BYTREE = 0.8  # frazione di feature usata per ogni albero
XGB_SCALE_POS_WEIGHT = None # peso classe positiva per bilanciamento (None = calcolato automaticamente)

# --- Grid Search ---
GRID_SEARCH_ENABLED = True        # False per saltare la grid search e usare i parametri XGB_* sopra
...
# --- Pre-processing ---
SCALE_FEATURES = False  # StandardScaler prima del modello
DROP_CONSTANT_COLS = True  # rimuovi colonne con varianza zero
DROP_NA_ROWS = True  # rimuovi righe con NaN
EXCLUDE_COLUMNS = ["sample_id", "path", "text", "label"] # lista di colonne da escludere manualmente (es. ["filename", "id"])
...
def build_pipeline() -> Pipeline:
    # XGBoost non supporta class_weight; il bilanciamento si gestisce con
    # scale_pos_weight = n_negative / n_positive (calcolato automaticamente se None)
    neg = int((y_global == 0).sum())
    pos = int((y_global == 1).sum())
...
# ==============================================================================
# 5. K-FOLD CROSS-VALIDATION (su train set)
# ==============================================================================
...
# ==============================================================================
# 6. ADDESTRAMENTO FINALE E VALUTAZIONE
# ==============================================================================
...
# ==============================================================================
# 7. SALVATAGGIO MATRICE DI CONFUSIONE
# ==============================================================================
...
# ==============================================================================
# 8. SALVATAGGIO METRICHE E MODELLO
# ==============================================================================
...
def main():
    log.info("=" * 60)
    log.info("Audio Clone Detection — XGBoost Classifier")
    log.info("=" * 60)
